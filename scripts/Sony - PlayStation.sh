...
_gen_dat_ps1() {
   echo "--- ${2} - DAT"
   $PYTHON ./generate-dat.py ${3} '{"game":{"rom":{"serial":"romSerial","image":"romFileName"},"name":"romExtensionlessFileName"}}' "${1}"
   mv "${1}.dat" "dat/${2}.dat"
}
...
_gen_developer_ps1() {
   ...
   $PYTHON ./generate-dat.py -s ${3} '{"game":{"rom":{"serial":"romSerial","image":"romFileName"},"name":"romExtensionlessFileName","developer":"releaseDeveloper"}}' "${1}"
...
_gen_publisher_ps1() {
   ...
   $PYTHON ./generate-dat.py -s ${3} '{"game":{"rom":{"serial":"romSerial","image":"romFileName"},"name":"romExtensionlessFileName","publisher":"releasePublisher"}}' "${1}"
...
_gen_releaseyear_ps1() {
   ...
   $PYTHON ./generate-dat.py -s ${3} '{"game":{"rom":{"serial":"romSerial","image":"romFileName"},"name":"romExtensionlessFileName","releaseyear":"Year"}}' "${1}"
...
_gen_releasemonth_ps1() {
   ...
   $PYTHON ./generate-dat.py -s ${3} '{"game":{"rom":{"serial":"romSerial","image":"romFileName"},"name":"romExtensionlessFileName","releasemonth":"Month"}}' "${1}"
